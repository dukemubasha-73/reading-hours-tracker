...
// v31: bumped after the emoji-to-SVG-icon visual design pass (index.html,
// app.js, styles.css all changed together). Skipping this bump is exactly
// the "stale app.js/styles.css served alongside fresh index.html" failure
// described above — confirmed it happened here (giant unsized icons +
// literal emoji text where the SVG header icon should be).
const CACHE_VERSION = "reading-hours-v31";
