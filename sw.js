...
// v31: bumped after the bottom-nav frosted-glass styles.css change (see chat).
// v32: bumped after increasing bottom-nav clearance to fix footer text
// bleeding through the translucent nav bar (see chat).
// v33: reverted bottom-nav to solid/opaque background, removed
// backdrop-filter entirely — suspected cause of the "Clear all data?"
// modal rendering with a broken/see-through backdrop (see chat). Kept
// the stronger box-shadow from v31, since that part was never implicated.
