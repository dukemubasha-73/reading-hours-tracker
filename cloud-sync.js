  ...
  //                                        streakMinimum, milestonesAwarded,
  //                                        chartType
  //
  ...
  function flattenExamResults(examResults) {
    ...
    (examResults || []).forEach(function (r) {
      map[r.id] = {
        ...
        // Optional field (added alongside the Performance summary/Highest
        // vs You chart) — default to null so old local records without it
        // still produce a valid, diffable record.
  ...
  function metaRecordFromState(state) {
    return {
      ...
      streakMinimum: state.streakMinimum,
  ...
  function pullCloudIntoLocal(sessionsSnap, subjectsSnap, examSnap, metaSnap) {
    ...
    const state = {
      ...
      streakMinimum: typeof meta.streakMinimum === "number" ? meta.streakMinimum : undefined,
  ...
  function syncOnSignIn(uid) {
    ...
    Promise.all([
      ...
      const mergedMeta = {
        ...
        streakMinimum: (metaSnap.exists() && typeof cloudMeta.streakMinimum === "number") ? cloudMeta.streakMinimum : localStateBefore.streakMinimum,
      ...
      const mergedState = {
        ...
        streakMinimum: mergedMeta.streakMinimum,
      ...
      const rawCloudMetaSig = stableStringify({
        ...
        streakMinimum: metaSnap.exists() ? cloudMeta.streakMinimum : undefined,
